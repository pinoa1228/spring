...
public class ConsultantDto {
    ...
    public ConsultantDto(@JsonProperty("consultant_num") Long consultant_num,@JsonProperty("name") String name,@JsonProperty("personal_num") Long personal_num,@JsonProperty("consultant_content") String consultant_content,@JsonProperty("consultant_date") LocalDate consultant_date) {
    ...
    public ConsultantEntity toEntity(){
        ...
        ConsultantEntity consultantEntity=new ConsultantEntity(consultant_num,name,personal_num,consultant_content,consultant_date);
